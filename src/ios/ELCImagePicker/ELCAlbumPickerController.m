    ...
    dispatch_async(dispatch_get_main_queue(), ^
    {
        ...
        // Group enumerator Block
            ...
            void (^assetGroupEnumberatorFailure)(NSError *) = ^(NSError *error) {
                ...
                UIAlertView * alert = [[UIAlertView alloc] initWithTitle:@"异常" message:[NSString stringWithFormat:@"相册异常: %@ - %@", [error localizedDescription], [error localizedRecoverySuggestion]] delegate:nil cancelButtonTitle:@"??" otherButtonTitles:nil];
                [alert show];
